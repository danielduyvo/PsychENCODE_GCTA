...
PROJECT="1MBase"
THREADS=2
mkdir -p $PROJECT/output/fin_peds
mkdir -p $PROJECT/output/graphs
mkdir -p $PROJECT/output/grm_chrs
mkdir -p $PROJECT/output/grm_ranges
mkdir -p $PROJECT/output/grms
mkdir -p $PROJECT/output/hsqs
mkdir -p $PROJECT/output/mgrms
